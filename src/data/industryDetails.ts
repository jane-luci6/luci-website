      ...
      zones: [
        {
          ...
          plate: { side: 'right', right: '-6%', top: '78%' },
          delay: 0,
          lines: [{ x1: 94, y1: 78, x2: 50, y2: 87 }],
        },
        {
          label: 'Move guests toward amenities',
          desc: 'Promote the spa at dusk and breakfast at dawn \u2014 the right offer at the right moment.',
          plate: { side: 'left', left: '-6%', top: '78%' },
          delay: 1,
          lines: [{ x1: 6, y1: 78, x2: 25, y2: 48 }],
        },
        {
          ...
          plate: { side: 'right', right: '-6%', top: '22%' },
          delay: 2,
          lines: [{ x1: 94, y1: 22, x2: 73, y2: 18 }],
        },
        {
    ...
    floorplan: {
      ...
      zones: [
        ...
        },
        {
          ...
          delay: 2,
          lines: [
            { x1: 6, y1: 78, x2: 50, y2: 48 },
            { x1: 6, y1: 64, x2: 50, y2: 24 },
            { x1: 6, y1: 64, x2: 52, y2: 76 },
          ],
        },
        {
