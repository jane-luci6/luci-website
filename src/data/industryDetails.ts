      ...
      zones: [
        {
          ...
          plate: { side: 'right', right: '-6%', top: '29%' },
          delay: 0,
          lines: [{ x1: 85, y1: 29, x2: 72, y2: 36 }],
        },
        {
          ...
          plate: { side: 'right', right: '-6%', top: '62.5%' },
          delay: 3.5,
          lines: [{ x1: 85, y1: 62.5, x2: 63.75, y2: 54.2 }],
        },
        {
          label: 'Move guests toward amenities',
          desc: 'Dining, entertainment, the pool — the spaces that now pay the bills, on cue.',
          plate: { side: 'left', left: '-6%', top: '52%' },
          delay: 7,
          lines: [
            { x1: 15, y1: 52, x2: 28.3, y2: 17.6 },
            { x1: 15, y1: 52, x2: 29.2, y2: 39.1 },
            { x1: 15, y1: 52, x2: 29.2, y2: 67.4 },
          ],
        },
        {
          label: 'Extend loyalty across every space',
          desc: 'The right moment, in the right place, at the right time — everywhere.',
          plate: { side: 'left', left: '-6%', top: '14%' },
          delay: 10.5,
          lines: [
            { x1: 15, y1: 14, x2: 50.4, y2: 14.6 },
            { x1: 15, y1: 14, x2: 63.75, y2: 52.7 },
          ],
        },
      ],
    },
