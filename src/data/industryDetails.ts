...
export const industryDetails: Partial<Record<IndustrySlug, IndustryDetail>> = {
  ...
  'hotels-resorts': {
    ...
    floorplan: {
      image: '/images/industries/hotel/floorplan.png?v=3',
      imageAlt:
      ...
      zones: [
        {
          ...
          plate: { side: 'right', right: '-10%', top: '78%' },
          delay: 0,
          lines: [{ x1: 96, y1: 78, x2: 50, y2: 87 }],
        },
        {
          label: 'Move guests toward amenities',
          desc: 'Promote the spa at dusk and breakfast at dawn \u2014 the right offer at the right moment.',
          plate: { side: 'left', left: '-10%', top: '78%' },
          delay: 1,
          lines: [{ x1: 4, y1: 78, x2: 25, y2: 48 }],
        },
        {
          ...
          plate: { side: 'right', right: '-10%', top: '20%' },
          delay: 2,
          lines: [{ x1: 96, y1: 20, x2: 73, y2: 18 }],
        },
        {
          label: 'Hold one brand across the property',
          desc: 'Every media interaction reinforces your marketing messages without drift.',
          plate: { side: 'left', left: '-10%', top: '20%' },
          delay: 3,
          lines: [{ x1: 4, y1: 20, x2: 50, y2: 26 }],
        },
      ],
    },
  ...
  'sports-venues': {
    ...
    floorplan: {
      image: '/images/industries/sports/floorplan.png?v=3',
      imageAlt:
      ...
      zones: [
        {
          ...
          plate: { side: 'right', right: '-10%', top: '22%' },
          delay: 0,
          lines: [{ x1: 96, y1: 22, x2: 52, y2: 50 }],
        },
        {
        ...
        },
        {
          ...
          delay: 2,
          lines: [
            { x1: 4, y1: 78, x2: 50, y2: 48 },
            { x1: 4, y1: 64, x2: 50, y2: 24 },
            { x1: 4, y1: 64, x2: 52, y2: 76 },
          ],
        },
        {
    ...
    floorplan: {
      ...
      zones: [
        ...
        },
        {
          ...
          plate: { side: 'left', left: '-10%', top: '76%' },
          delay: 1,
          lines: [{ x1: 4, y1: 76, x2: 23, y2: 48 }],
        },
        {
        ...
        },
        {
          ...
          plate: { side: 'left', left: '-10%', top: '24%' },
          delay: 3,
          lines: [{ x1: 4, y1: 24, x2: 50, y2: 45 }],
        },
      ],
    },
  ...
  'conference-convention-centers': {
    ...
    floorplan: {
      image: '/images/industries/conference-convention-centers/floorplan.png?v=3',
