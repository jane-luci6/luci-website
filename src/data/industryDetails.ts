...
export const industryDetails: Partial<Record<IndustrySlug, IndustryDetail>> = {
  'casinos-gaming': {
    ...
    floorplan: {
      image: '/images/industries/casino/casino-floorplan.png?v=3',
      imageAlt:
      ...
      zones: [
        {
          ...
          plate: { side: 'right', right: '-6%', top: '27.23%' },
          delay: 0,
          lines: [{ x1: 89.98, y1: 27.23, x2: 74.52, y2: 36.8 }],
        },
        {
        ...
        },
        {
          ...
          lines: [
            ...
            { x1: 6.7, y1: 58.68, x2: 23.6, y2: 79.73 },
          ],
        },
        {
  ...
  'hotels-resorts': {
    ...
    floorplan: {
      image: '/images/industries/hotel/floorplan.png?v=2',
      imageAlt:
      ...
      zones: [
        {
          ...
          plate: { side: 'right', right: '-6%', top: '80%' },
          delay: 0,
          lines: [{ x1: 90, y1: 80, x2: 50, y2: 87 }],
        },
        {
          label: 'Move guests toward amenities',
          desc: 'Promote the spa at dusk and breakfast at dawn \u2014 the right offer at the right moment.',
          plate: { side: 'left', left: '-6%', top: '74%' },
          delay: 1,
          lines: [{ x1: 8, y1: 74, x2: 25, y2: 48 }],
        },
        {
          ...
          plate: { side: 'right', right: '-6%', top: '30%' },
          delay: 2,
          lines: [{ x1: 90, y1: 30, x2: 73, y2: 18 }],
        },
        {
          label: 'Hold one brand across the property',
          desc: 'Every media interaction reinforces your marketing messages without drift.',
          plate: { side: 'left', left: '-6%', top: '22%' },
          delay: 3,
          lines: [{ x1: 8, y1: 22, x2: 50, y2: 26 }],
        },
      ],
    },
  ...
  'sports-venues': {
    ...
    floorplan: {
      image: '/images/industries/sports/floorplan.png?v=2',
      imageAlt:
      ...
      zones: [
        {
          ...
          plate: { side: 'right', right: '-6%', top: '26%' },
          delay: 0,
          lines: [{ x1: 90, y1: 26, x2: 52, y2: 50 }],
        },
        {
          ...
          plate: { side: 'right', right: '-6%', top: '72%' },
          delay: 1,
          lines: [{ x1: 90, y1: 72, x2: 54, y2: 28 }],
        },
        {
          ...
          plate: { side: 'left', left: '-6%', top: '64%' },
          delay: 2,
          lines: [
            { x1: 8, y1: 64, x2: 50, y2: 48 },
            { x1: 8, y1: 64, x2: 50, y2: 24 },
            { x1: 8, y1: 64, x2: 52, y2: 76 },
          ],
        },
        {
          ...
          plate: { side: 'left', left: '-6%', top: '20%' },
          delay: 3,
          lines: [{ x1: 8, y1: 20, x2: 50, y2: 70 }],
        },
      ],
    },
  ...
  'airports-transportation': {
    ...
    floorplan: {
      image: '/images/industries/airports-transportation/floorplan.png?v=2',
      imageAlt:
      ...
      zones: [
        ...
        },
        {
          ...
          plate: { side: 'left', left: '-6%', top: '76%' },
          delay: 1,
          lines: [{ x1: 8, y1: 76, x2: 23, y2: 48 }],
        },
        {
        ...
        },
        {
          ...
          plate: { side: 'left', left: '-6%', top: '24%' },
          delay: 3,
          lines: [{ x1: 8, y1: 24, x2: 50, y2: 45 }],
        },
      ],
    },
  ...
  'conference-convention-centers': {
    ...
    floorplan: {
      image: '/images/industries/conference-convention-centers/floorplan.png?v=2',
      ...
      zones: [
        ...
        },
        {
          ...
          plate: { side: 'left', left: '-6%', top: '80%' },
          delay: 3,
          lines: [{ x1: 8, y1: 80, x2: 20, y2: 75 }],
        },
      ],
    },
    challengesLockup: {
