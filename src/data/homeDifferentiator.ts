/** Compact callout between the hero and section 2 — the "one interface controls all of it" differentiator */

export const homeDifferentiator = {
  // The scrolling ticker (the full list of systems a property runs today) lives here now.
